...
import { SuccessResponse, DonationRequest, DonationResponse , BraintreeEndpointManagerInterface } from "../index";
...
export class BraintreeEndpointManager implements BraintreeEndpointManagerInterface {
  ...
  donationSuccessful(options: {
    ...
    const payload: { [key: string]: string | undefined } = {
      ...
      'donation-type': options.upsellSuccessResponse ? 'upsell' : options.successResponse.donationType,
